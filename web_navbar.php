...
<li<?=(isset($pageName) && $pageName == 'depart_serv')?' class="active"':'';?>>
    <div class="sub_menu">
...
<li<?=(isset($pageName) && $pageName == 'human_res')?' class="active"':'';?>>
    <div class="sub_menu">
        ...
        <ul class="web_sbmnu_lst">
            <li<?=(isset($pageSubName) && $pageSubName == 'administration')?' class="active"':'';?>><a href="administration.php"><?=site_text('administration', 'الادارة');?></a></li>
            <li<?=(isset($pageSubName) && $pageSubName == 'careers')?' class="active"':'';?>><a href="careers.php"><?=site_text('careers', 'وظائف');?></a></li>
        </ul>
    </div>
</li>
